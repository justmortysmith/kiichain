...
import (
	...
	kiichainaApp "github.com/kiichain/kiichain/v1/app"
)
...
func init() {
	...
	ccvSuite = integration.NewCCVTestSuite[*kiichainaApp.KiichainApp, *appConsumer.App](
		// Pass in ibctesting.AppIniters for kiichain (provider) and consumer.
		KiichainAppIniterTempDir, icstestingutils.ConsumerAppIniter, []string{})
