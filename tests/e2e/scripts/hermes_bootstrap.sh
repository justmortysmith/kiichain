...
store_prefix = 'ibc'
max_gas = 6000000
gas_price = { price = 0.005, denom = 'akii' }
gas_multiplier = 1.5
...
# import keys
hermes keys add  --key-name rly01-kiichain-b  --chain $KIICHAIN_B_E2E_CHAIN_ID --mnemonic-file /root/.hermes/KIICHAIN_B_E2E_RLY_MNEMONIC.txt
sleep 5
hermes keys add  --key-name rly01-kiichain-a  --chain $KIICHAIN_A_E2E_CHAIN_ID --mnemonic-file /root/.hermes/KIICHAIN_A_E2E_RLY_MNEMONIC.txt
